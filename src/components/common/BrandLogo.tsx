    ...
    <div className="flex items-center gap-2 select-none" aria-label="punleukrek pharmacy">
      ...
      >
        ...
        <path
          ...
          fill={mounted ? (isDark ? 'var(--gray-3)' : '#F2FBF7') : '#F2FBF7'}
          stroke={accent}
          strokeWidth="0.6"
        />
        {/* Dual-tone cross with subtle depth */}
        <path d="M13.2 7.2h-2.4v3.2H7.6v2.4h3.2V16h2.4v-3.2h3.2v-2.4h-3.2V7.2Z" fill={accent} />
        <path d="M13.2 7.2h-1.2v3.2h-3.2v1.2h3.2V16h1.2v-4.4h4.4v-1.2h-4.4V7.2Z" fill={mounted ? (isDark ? 'rgba(0,0,0,0.08)' : 'rgba(255,255,255,0.6)') : 'rgba(255,255,255,0.6)'} />
      </svg>
      {showText && (
        <span
